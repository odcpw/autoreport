...
2. Open:
   - `http://127.0.0.1:<port>/program/experiments/ai-evidence-lab/index.html`
...
```bash
node program/experiments/ai-evidence-lab/scripts/run_qa_e2e.mjs
node program/experiments/ai-evidence-lab/scripts/verify_offline_mode.mjs
```
