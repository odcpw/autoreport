...
Scope: Standalone experiment in `program/experiments/`, no dependency on main app runtime.
...
- Separate page under `program/experiments/ai-voice-report/`.
...
`program/experiments/ai-voice-report/`
- `README.md`
- `SPEC.md`
- `TASKS.md`
- `index.html`
