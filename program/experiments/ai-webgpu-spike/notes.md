...
- Fix: updated `program/tools/serve-autobericht.ps1` to return:
...
### Scope & assumptions
- You run the spike from `program/experiments/` and keep assets in `program/AI/`.
...
- All model files, runtime files, and configs are served from disk under `program/AI/`.
