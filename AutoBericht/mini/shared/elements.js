(() => {
  const getElements = () => ({
    ...
    observationsOrganizeModal: document.getElementById("observations-organize-modal"),
    observationsOrganizeBackdrop: document.getElementById("observations-organize-close"),
    observationsOrganizeCloseBtn: document.getElementById("observations-organize-close-btn"),
    observationsOrganizeSearchEl: document.getElementById("observations-organize-search"),
    observationsOrganizeFiltersEl: document.getElementById("observations-organize-filters"),
    observationsOrganizeSortsEl: document.getElementById("observations-organize-sorts"),
    observationsOrganizeStatusEl: document.getElementById("observations-organize-status"),
    observationsOrganizeListEl: document.getElementById("observations-organize-list"),
    observationsOrganizeApplyBtn: document.getElementById("observations-organize-apply"),
    observationsOrganizeResetBtn: document.getElementById("observations-organize-reset"),
    observationsOrganizeCancelBtn: document.getElementById("observations-organize-cancel"),
