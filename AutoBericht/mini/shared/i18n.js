(() => {
  const locales = {
    en: {
      ...
      project_tool_migration_title: "Sidecar Migration",
      project_tool_migration_hint: "Run one-time cleanup for legacy sidecar schema and save a backup in backup/.",
      project_tool_migration: "Migrate Legacy Sidecar",
      project_tool_migration_missing: "Migration handler is not available.",
      project_tool_migration_running: "Migrating ...",
    ...
    "de-CH": {
      ...
      project_tool_migration_title: "Sidecar-Migration",
      project_tool_migration_hint: "Einmalige Bereinigung fuer Legacy-Sidecar-Schema ausfuehren und Backup in backup/ speichern.",
      project_tool_migration: "Legacy-Sidecar migrieren",
      project_tool_migration_missing: "Migration-Handler ist nicht verfuegbar.",
      project_tool_migration_running: "Migriere ...",
      project_tool_log_title: "Debug-Log",
    ...
    "fr-CH": {
      ...
      project_tool_migration_title: "Migration sidecar",
      project_tool_migration_hint: "Executer un nettoyage unique du schema sidecar legacy et enregistrer une sauvegarde dans backup/.",
      project_tool_migration: "Migrer sidecar legacy",
      project_tool_migration_missing: "Le gestionnaire de migration n'est pas disponible.",
      project_tool_migration_running: "Migration ...",
    ...
    "it-CH": {
      ...
      project_tool_migration_title: "Migrazione sidecar",
      project_tool_migration_hint: "Esegui la pulizia una tantum dello schema sidecar legacy e salva un backup in backup/.",
      project_tool_migration: "Migra sidecar legacy",
      project_tool_migration_missing: "L'handler di migrazione non e disponibile.",
      project_tool_migration_running: "Migrazione ...",
