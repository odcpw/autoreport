(() => {
  ...
  // Instructional hints and card titles follow the report language so that a
  // French- or Italian-speaking engineer reads the guidance in their language.
  // Controls, status messages and errors stay in English (see uiText).
  const hintText = {
    "de-CH": {
    ...
    "fr-CH": {
      ...
      chapter0_front_matter: "Contexte client (texte d'introduction)",
    ...
    "it-CH": {
      ...
      chapter0_front_matter: "Contesto cliente (testo introduttivo)",
