...
This index points to the **current** redesign documentation.

## Project Status

- **Current state vs target**: [STATUS](STATUS.md)
- **Redesign interview spec**: [Design Spec](../AutoBericht/docs/design-spec.md)
...
1. **[AutoBericht UI](../AutoBericht/README.md)** - UI overview
2. **[Design Spec](../AutoBericht/docs/design-spec.md)** - Data + flow details
